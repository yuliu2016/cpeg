...
static void *t_primary(parser_t *p) {
    ...
    p->pos = maxpos;
    _t_primary = max ? node_1(p, &f, max) : 0;
...
static void *disjunction(parser_t *p) {
    ...
    p->pos = maxpos;
    _disjunction = max ? node_1(p, &f, max) : 0;
...
static void *conjunction(parser_t *p) {
    ...
    p->pos = maxpos;
    _conjunction = max ? node_1(p, &f, max) : 0;
...
static void *bitwise_or(parser_t *p) {
    ...
    p->pos = maxpos;
    _bitwise_or = max ? node_1(p, &f, max) : 0;
...
static void *bitwise_xor(parser_t *p) {
    ...
    p->pos = maxpos;
    _bitwise_xor = max ? node_1(p, &f, max) : 0;
...
static void *bitwise_and(parser_t *p) {
    ...
    p->pos = maxpos;
    _bitwise_and = max ? node_1(p, &f, max) : 0;
...
static void *shift_expr(parser_t *p) {
    ...
    p->pos = maxpos;
    _shift_expr = max ? node_1(p, &f, max) : 0;
...
static void *pipe_expr(parser_t *p) {
    ...
    p->pos = maxpos;
    _pipe_expr = max ? node_1(p, &f, max) : 0;
